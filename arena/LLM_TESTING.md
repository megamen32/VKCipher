...
из git. В нём отсутствующее в ответе LLM слово считается `safe`; при
изменении этого правила нужно обновить regression-тест и повторить полный
прогон. Разметка описывает мнение одной модели, а не универсальную гарантию
для всех антиспам- и moderation-систем.
