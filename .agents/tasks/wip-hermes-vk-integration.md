...
- [ ] Canonical Hermes project and license verified.
- [ ] VK support and extension API verified.
- [ ] Three integration levels and recommendation documented.
- [ ] Acceptance evidence recorded in this task file.
- [ ] Move `wip-hermes-vk-integration.md` to `done-hermes-vk-integration.md` and commit.
