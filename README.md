...
**Русские слова (экспериментально):** шифротекст можно передавать markerless-пакетами из фиксированного словаря `ru-common-8192-v3`. В нём сначала идут слова, которые `gemma4` пометила как `safe`, затем короткие слова из той же исходной выборки, помеченные `borderline`, чтобы сохранить 8192 индекса. Исходный denylist исключён. Длинные сообщения автоматически разбиваются на части до 4000 UTF-16 единиц VK и собираются обратно после получения всех частей. Это транспортный формат, а не гарантия естественной или незаметной речи.
